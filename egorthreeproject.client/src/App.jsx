    ...
    return (
        <div style={{ width: '100%', boxSizing: 'border-box' }}>
            {showPopup 
                ?
                (
                    <Popup pictures={pictures[cardId].pictures} product={products[cardId]}/>
                ) 
                :
                (<div>
                    ...
                    <ProductCategoryFilter products={products} categories={categories} pictures={pictures} onCardClick={handleCardClick} />
                </div>)}
        </div>
    );
}
